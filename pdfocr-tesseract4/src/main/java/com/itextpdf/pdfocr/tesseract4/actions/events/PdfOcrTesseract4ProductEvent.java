...
public class PdfOcrTesseract4ProductEvent extends AbstractProductProcessITextEvent {
     ...
     */
    private PdfOcrTesseract4ProductEvent(SequenceId sequenceId, IMetaInfo metaInfo, String eventType,
            EventConfirmationType eventConfirmationType) {
        super(sequenceId, PdfOcrTesseract4ProductData.getInstance(), metaInfo, eventConfirmationType);
     ...
     * @param eventConfirmationType is an event confirmation type
     *
     * @return process-image event
     */
    public static PdfOcrTesseract4ProductEvent createProcessImageEvent(SequenceId sequenceId,
            IMetaInfo metaInfo, EventConfirmationType eventConfirmationType) {
        return new PdfOcrTesseract4ProductEvent(sequenceId, metaInfo, PROCESS_IMAGE, eventConfirmationType);
    }
