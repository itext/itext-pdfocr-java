...
public class Tesseract4LogMessageConstant {
    ...
    public static final String CANNOT_OCR_INPUT_FILE = "Cannot ocr input file: {0}";
    ...
    public static final String CANNOT_CONVERT_IMAGE_TO_GRAYSCALE = "Cannot convert to gray image with depth {0}";
