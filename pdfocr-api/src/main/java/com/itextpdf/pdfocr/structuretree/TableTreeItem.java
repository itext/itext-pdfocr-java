...
public class TableTreeItem extends LogicalStructureTreeItem {
    ...
    /**
     * Instantiate a new {@link TableTreeItem} instance.
     */
    public TableTreeItem() {
        super(new DefaultAccessibilityProperties(StandardRoles.TABLE));
    }

    /**
     * Add a new row structure tree item to the table.
     *
     * @param rowItem row structure tree item to be added.
     * @return this {@link TableTreeItem} instance.
     */
