 ...
 *
 * <p>
 * It pretty much implements {@link com.itextpdf.pdfocr.onnx.IOutputLabelMapper}
...
public class Vocabulary {
    ...
    public static final Vocabulary HINDI_DIGITS = new Vocabulary("٠١٢٣٤٥٦٧٨٩");

    public static final Vocabulary GENERIC_CYRILLIC_LETTERS = new Vocabulary("абвгдежзийклмнопрстуфхцчшщьюяАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЬЮЯ");
    public static final Vocabulary RUSSIAN_CYRILLIC_LETTERS = new Vocabulary("ёыэЁЫЭ");
    public static final Vocabulary RUSSIAN_SIGNS = new Vocabulary("ъЪ");
    public static final Vocabulary ANCIENT_GREEK = new Vocabulary("αβγδεζηθικλμνξοπρστςυφχψωΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩ");
    public static final Vocabulary ARABIC_DIACRITICS = new Vocabulary("ًٌٍَُِّْٕٓٔٚ");
    public static final Vocabulary ARABIC_DIGITS = new Vocabulary("٠١٢٣٤٥٦٧٨٩");
    public static final Vocabulary ARABIC_LETTERS = new Vocabulary("ءآأؤإئابةتثجحخدذرزسشصضطظعغـفقكلمنهوىيٱ");
    public static final Vocabulary ARABIC_PUNCTUATION = new Vocabulary("؟؛«»—،");
    public static final Vocabulary PERSIAN_LETTERS = new Vocabulary("پچژڢڤگکی");
    public static final Vocabulary BENGALI_CONSONANTS = new Vocabulary("কখগঘঙচছজঝঞটঠডঢণতথদধনপফবভমযরলশষসহড়ঢ়য়ৰৱৼ");
    public static final Vocabulary BENGALI_VOWELS = new Vocabulary("অআইঈউঊঋঌএঐওঔৠৡ");
    public static final Vocabulary BENGALI_DIGITS = new Vocabulary("০১২৩৪৫৬৭৮৯");
    public static final Vocabulary BENGALI_MATRAS = new Vocabulary("ািীুূৃেৈোৌৗ");
    public static final Vocabulary BENGALI_VIRAMA = new Vocabulary("্");
    public static final Vocabulary BENGALI_PUNCTUATION = new Vocabulary("ঽৎ৽৺৻");
    public static final Vocabulary BENGALI_SIGNS = new Vocabulary("ঁংঃ়");
    public static final Vocabulary GUJARATI_CONSONANTS = new Vocabulary("કખગઘઙચછજઝઞટઠડઢણતથદધનપફબભમયરલળવશષસહ");
    public static final Vocabulary GUJARATI_VOWELS = new Vocabulary("અઆઇઈઉઊઋઌઍએઐઑઓઔ");
    public static final Vocabulary GUJARATI_DIGITS = new Vocabulary("૦૧૨૩૪૫૬૭૮૯");
    public static final Vocabulary GUJARATI_MATRAS = new Vocabulary("ઁંઃ઼ાિીુૂૃૄૅેૈૉોૌૢૣૺૻૼ૽૾૿");
    public static final Vocabulary GUJARATI_VIRAMA = new Vocabulary("્");
    public static final Vocabulary GUJARATI_PUNCTUATION = new Vocabulary("ઽ॥");
    public static final Vocabulary GUJARATI_SIGNS = new Vocabulary("ૐ૰");
    public static final Vocabulary DEVANAGARI_CONSONANTS = new Vocabulary("कखगघङचछजझञटठडढणतथदधनपफबभमयरलवशषसहऴऩळक़ख़ग़ज़ड़ढ़फ़य़ऱॺॻॼॽॾ");
    public static final Vocabulary DEVANAGARI_VOWELS = new Vocabulary("अआइईउऊऋऌऍऎएऐऑऒओऔॠॡॲऄॵॶॳॴॷॸॹ");
    public static final Vocabulary DEVANAGARI_DIGITS = new Vocabulary("०१२३४५६७८९");
    public static final Vocabulary DEVANAGARI_MATRAS = new Vocabulary("़ंँः॒॑ािीुूृॄॅॆेैॉॊोौॢॣॏॎ");
    public static final Vocabulary DEVANAGARI_VIRAMA = new Vocabulary("्");
    public static final Vocabulary DEVANAGARI_PUNCTUATION = new Vocabulary("।॥॰ऽꣲ");
    public static final Vocabulary DEVANAGARI_SIGNS = new Vocabulary("ॐ");
    public static final Vocabulary PUNJABI_CONSONANTS = new Vocabulary("ਕਖਗਘਙਚਛਜਝਞਟਠਡਢਣਤਥਦਧਨਪਫਬਭਮਯਰਲਵਸ਼ਸਹਖ਼ਗ਼ਜ਼ਫ਼ੜਲ਼");
    public static final Vocabulary PUNJABI_VOWELS = new Vocabulary("ਅਆਇਈਉਊਏਐਓਔੲੳ");
    public static final Vocabulary PUNJABI_DIGITS = new Vocabulary("੦੧੨੩੪੫੬੭੮੯");
    public static final Vocabulary PUNJABI_MATRAS = new Vocabulary("ਂ਼ਾਿੀੁੂੇੈੋੌੑੰੱੵ");
    public static final Vocabulary PUNJABI_VIRAMA = new Vocabulary("੍");
    public static final Vocabulary PUNJABI_PUNCTUATION = new Vocabulary("।॥");
    public static final Vocabulary PUNJABI_SIGNS = new Vocabulary("ੴ");
    public static final Vocabulary TAMIL_CONSONANTS = new Vocabulary("கஙசஞடணதநபமயரலவழளறன");
    public static final Vocabulary TAMIL_VOWELS = new Vocabulary("அஆஇஈஉஊஎஏஐஒஓஔ");
    public static final Vocabulary TAMIL_DIGITS = new Vocabulary("௦௧௨௩௪௫௬௭௮௯");
    public static final Vocabulary TAMIL_MATRAS = new Vocabulary("ாிீுூெேைொோௌ");
    public static final Vocabulary TAMIL_VIRAMA = new Vocabulary("்");
    public static final Vocabulary TAMIL_PUNCTUATION = new Vocabulary("௰௱௲");
    public static final Vocabulary TAMIL_SIGNS = new Vocabulary("ஃௐ");
    public static final Vocabulary TAMIL_FRACTIONS = new Vocabulary("௳௴௵௶௷௸௹௺");
    public static final Vocabulary TELUGU_CONSONANTS = new Vocabulary("కఖగఘఙచఛజఝఞటఠడఢణతథదధనపఫబభమయరఱలళవశషసహఴ");
    public static final Vocabulary TELUGU_DIGITS = new Vocabulary("౦౧౨౩౪౫౬౭౮౯౸౹౺౻");
    public static final Vocabulary TELUGU_VOWELS = new Vocabulary("అఆఇఈఉఊఋఌఎఏఐఒఓఔౠౡ");
    public static final Vocabulary TELUGU_MATRAS = new Vocabulary("ాిీుూృౄెేైొోౌౢౣ");
    public static final Vocabulary TELUGU_VIRAMA = new Vocabulary("్");
    public static final Vocabulary TELUGU_PUNCTUATION = new Vocabulary("ఽ");
    public static final Vocabulary TELUGU_SIGNS = new Vocabulary("ఁంః");
    public static final Vocabulary KANNADA_CONSONANTS = new Vocabulary("ಕಖಗಘಙಚಛಜಝಞಟಠಡಢಣತಥದಧನಪಫಬಭಮಯರಲವಶಷಸಹಳ");
    public static final Vocabulary KANNADA_VOWELS = new Vocabulary("ಅಆಇಈಉಊಋॠಌೡಎಏಐಒಓಔ");
    public static final Vocabulary KANNADA_DIGITS = new Vocabulary("೦೧೨೩೪೫೬೭೮೯");
    public static final Vocabulary KANNADA_MATRAS = new Vocabulary("ಾಿೀುೂೃೄೆೇೈೊೋೌ");
    public static final Vocabulary KANNADA_VIRAMA = new Vocabulary("್");
    public static final Vocabulary KANNADA_PUNCTUATION = new Vocabulary("।॥ೱೲ");
    public static final Vocabulary KANNADA_SIGNS = new Vocabulary("ಂಃಁ");
    public static final Vocabulary SINHALA_CONSONANTS = new Vocabulary("කඛගඝඞචඡජඣඤටඨඩඪණතථදධනපඵබභමයරලවශෂසහළෆ");
    public static final Vocabulary SINHALA_VOWELS = new Vocabulary("අආඇඈඉඊඋඌඍඎඏඐඑඒඓඔඕඖ");
    public static final Vocabulary SINHALA_DIGITS = new Vocabulary("෦෧෨෩෪෫෬෭෮෯");
    public static final Vocabulary SINHALA_MATRAS = new Vocabulary("ාැෑිීුූෙේෛොෝෞ");
    public static final Vocabulary SINHALA_VIRAMA = new Vocabulary("්");
    public static final Vocabulary SINHALA_PUNCTUATION = new Vocabulary("෴");
    public static final Vocabulary SINHALA_SIGNS = new Vocabulary("ංඃ");
    public static final Vocabulary MALAYALAM_CONSONANTS = new Vocabulary("കഖഗഘങചഛജഝഞടഠഡഢണതഥദധനപഫബഭമയരറലളഴവശഷസഹ");
    public static final Vocabulary MALAYALAM_VOWELS = new Vocabulary("അആഇഈഉഊഋൠഌൡഎഏഐഒഓഔ");
    public static final Vocabulary MALAYALAM_DIGITS = new Vocabulary("൦൧൨൩൪൫൬൭൮൯");
    public static final Vocabulary MALAYALAM_MATRAS = new Vocabulary("ാിീുൂൃൄൢൣെേൈൊോൌ");
    public static final Vocabulary MALAYALAM_VIRAMA = new Vocabulary("്");
    public static final Vocabulary MALAYALAM_SIGNS = new Vocabulary("ഃ൹ഽ൏ം");
    public static final Vocabulary ODIA_CONSONANTS = new Vocabulary("କଖଗଘଙଚଛଜଝଞଟଠଡଢଣତଥଦଧନପଫବଭମଯରଲଳଵଶଷସହୟୱଡ଼ଢ଼");
    public static final Vocabulary ODIA_VOWELS = new Vocabulary("ଅଆଇଈଉଊଋଌଏଐଓଔୡୠ");
    public static final Vocabulary ODIA_DIGITS = new Vocabulary("୦୧୨୩୪୫୬୭୮୯୲୳୴୵୶୷");
    public static final Vocabulary ODIA_MATRAS = new Vocabulary("ାିୀୁୂୃୄେୈୋୌୢୣ");
    public static final Vocabulary ODIA_VIRAMA = new Vocabulary("୍");
    public static final Vocabulary ODIA_PUNCTUATION = new Vocabulary("ଽ");
    public static final Vocabulary ODIA_SIGNS = new Vocabulary("ଂଃଁ଼୰");
    public static final Vocabulary KHMER_CONSONANTS = new Vocabulary("កខគឃងចឆជឈញដឋឌឍណតថទធនបផពភមយរលវឝឞសហឡអ");
    public static final Vocabulary KHMER_VOWELS = new Vocabulary("ឣឤឥឦឧឨឩឪឫឬឭឮឯឰឱឲឳ");
    public static final Vocabulary KHMER_DIGITS = new Vocabulary("០១២៣៤៥៦៧៨៩");
    public static final Vocabulary KHMER_MATRAS = new Vocabulary("ាិីឹឺុូួើឿៀេែៃោៅ");
    public static final Vocabulary KHMER_DIACRITICS = new Vocabulary("ំះៈ៉៊់៌៍៎៏័៑៓៝");
    public static final Vocabulary KHMER_VIRAMA = new Vocabulary("្");
    public static final Vocabulary KHMER_PUNCTUATION = new Vocabulary("។៕៖៘៙៚ៗៜ");
    public static final Vocabulary BURMESE_CONSONANTS = new Vocabulary("ကခဂဃငစဆဇဈဉညဋဌဍဎဏတထဒဓနပဖဗဘမယရလဝသဟဠအၐၑၒၓၔၕၚၛၜၝၡၥၦၮၯၰၵၶၷၸၹၺၻၼၽၾၿႀႁႎ");
    public static final Vocabulary BURMESE_VOWELS = new Vocabulary("ဣဤဥဦဧဩဪဿ");
    public static final Vocabulary BURMESE_DIGITS = new Vocabulary("၀၁၂၃၄၅၆၇၈၉႐႑႒႓႔႕႖႗႘႙");
    public static final Vocabulary BURMESE_DIACRITICS = new Vocabulary("့းံါာိီုူေဲဳဴဵျြွှ");
    public static final Vocabulary BURMESE_VIRAMA = new Vocabulary("္်");
    public static final Vocabulary BURMESE_PUNCTUATION = new Vocabulary("၊။၌၍၎၏ၤၗ");
    public static final Vocabulary JAVANESE_CONSONANTS = new Vocabulary("ꦏꦐꦑꦒꦓꦔꦕꦖꦗꦘꦙꦚꦛꦜꦝꦞꦟꦠꦡꦢꦣꦤꦥꦦꦧꦨꦩꦪꦫꦬꦭꦮꦯꦰꦱꦲ");
    public static final Vocabulary JAVANESE_VOWELS = new Vocabulary("ꦄꦅꦆꦇꦈꦉꦊꦋꦌꦍꦎꦴꦵꦶꦷꦸꦹꦺꦻꦼ");
    public static final Vocabulary JAVANESE_DIGITS = new Vocabulary("꧐꧑꧒꧓꧔꧕꧖꧗꧘꧙");
    public static final Vocabulary JAVANESE_DIACRITICS = new Vocabulary("ꦀꦁꦂꦃ꦳ꦽꦾꦿ");
    public static final Vocabulary JAVANESE_VIRAMA = new Vocabulary("꧀");
    public static final Vocabulary JAVANESE_PUNCTUATION = new Vocabulary("꧈꧉꧊꧋꧌꧍ꧏ");
    public static final Vocabulary SUDANESE_CONSONANTS = new Vocabulary("ᮊᮋᮌᮍᮎᮏᮐᮑᮒᮓᮔᮕᮖᮗᮘᮙᮚᮛᮜᮝᮞᮟᮠᮮᮯᮺᮻᮼᮽᮾᮿ");
    public static final Vocabulary SUDANESE_VOWELS = new Vocabulary("ᮃᮄᮅᮆᮇᮈᮉ");
    public static final Vocabulary SUDANESE_DIGITS = new Vocabulary("᮰᮱᮲᮳᮴᮵᮶᮷᮸᮹");
    public static final Vocabulary SUDANESE_DIACRITICS = new Vocabulary("ᮀᮁᮂᮡᮢᮣᮤᮥᮦᮧᮨᮩ᮪᮫ᮬᮭ");
    public static final Vocabulary HEBREW_CANTILLATIONS = new Vocabulary("֑֖֛֢֣֤֥֦֧֪֚֭֮֒֓֔֕֗֘֙֜֝֞֟֠֡֨֩֫֬֯");
    public static final Vocabulary HEBREW_CONSONANTS = new Vocabulary("אבגדהוזחטיךכלםמןנסעףפץצקרשת");
    public static final Vocabulary HEBREW_SPECIALS = new Vocabulary("ׯװױײיִﬞײַﬠﬡﬢﬣﬤﬥﬦﬧﬨ﬩שׁשׂשּׁשּׂאַאָאּבּגּדּהּוּזּטּיּךּכּלּמּנּסּףּפּצּקּרּשּתּוֹבֿכֿפֿﭏ");
    public static final Vocabulary HEBREW_PUNCTUATION = new Vocabulary("ֽ־ֿ׀ׁׂ׃ׅׄ׆׳״");
    public static final Vocabulary HEBREW_VOWELS = new Vocabulary("ְֱֲֳִֵֶַָׇֹֺֻ");

    public static final Vocabulary ALBANIAN = concat(ENGLISH, new Vocabulary("çëÇË"));

    public static final Vocabulary AFRIKAANS = concat(ENGLISH, new Vocabulary("èëïîôûêÈËÏÎÔÛÊ"));

    public static final Vocabulary BASQUE = concat(ENGLISH, new Vocabulary("ñçÑÇ"));

    public static final Vocabulary CATALAN = concat(ENGLISH, new Vocabulary("àèéíïòóúüçÀÈÉÍÏÒÓÚÜÇ"));

    public static final Vocabulary CROATIAN = concat(ENGLISH, new Vocabulary("ČčĆćĐđŠšŽž"));

    public static final Vocabulary CZECH = concat(ENGLISH, new Vocabulary("áčďéěíňóřšťúůýžÁČĎÉĚÍŇÓŘŠŤÚŮÝŽ"));

    public static final Vocabulary DANISH = concat(ENGLISH, new Vocabulary("æøåÆØÅ"));

    public static final Vocabulary DUTCH = concat(ENGLISH, new Vocabulary("áéíóúüñÁÉÍÓÚÜÑ"));

    public static final Vocabulary ESTONIAN = concat(ENGLISH, new Vocabulary("šžõäöüŠŽÕÄÖÜ"));

    public static final Vocabulary FINNISH = concat(ENGLISH, new Vocabulary("äöÄÖ"));

    public static final Vocabulary GERMAN = concat(ENGLISH, new Vocabulary("äöüßÄÖÜẞ"));

    public static final Vocabulary HUNGARIAN = concat(ENGLISH, new Vocabulary("áéíóöúüÁÉÍÓÖÚÜ"));

    public static final Vocabulary INDONESIAN = ENGLISH;

    public static final Vocabulary IRISH = concat(ENGLISH, new Vocabulary("áéíóúÁÉÍÓÚ"));

    public static final Vocabulary ITALIAN = concat(ENGLISH, new Vocabulary("àèéìíîòóùúÀÈÉÌÍÎÒÓÙÚ"));

    public static final Vocabulary LUXEMBOURGISH = concat(ENGLISH, new Vocabulary("äöüéëÄÖÜÉË"));

    public static final Vocabulary MALAY = ENGLISH;

    public static final Vocabulary NORWEGIAN = concat(ENGLISH, new Vocabulary("æøåÆØÅ"));

    public static final Vocabulary POLISH = concat(ENGLISH, new Vocabulary("ąćęłńóśźżĄĆĘŁŃÓŚŹŻ"));

    public static final Vocabulary PORTUGUESE = concat(ENGLISH, new Vocabulary("áàâãéêíïóôõúüçÁÀÂÃÉÊÍÏÓÔÕÚÜÇ"));

    public static final Vocabulary ROMANIAN = concat(ENGLISH, new Vocabulary("ăâîșțĂÂÎȘȚ"));

    public static final Vocabulary SERBIAN_LATIN = concat(ENGLISH, new Vocabulary("čćđžšČĆĐŽŠ"));

    public static final Vocabulary SLOVAK = concat(ENGLISH, new Vocabulary("ôäčďľňšťžáéíĺóŕúýÔÄČĎĽŇŠŤŽÁÉÍĹÓŔÚÝ"));

    public static final Vocabulary SPANISH = concat(ENGLISH, new Vocabulary("áéíóúüñÁÉÍÓÚÜÑ"), new Vocabulary("¡¿"));

    public static final Vocabulary SWEDISH = concat(ENGLISH, new Vocabulary("åäöÅÄÖ"));

    public static final Vocabulary VIETNAMESE = concat(
            ENGLISH,
            new Vocabulary("áàảạãăắằẳẵặâấầẩẫậđéèẻẽẹêếềểễệóòỏõọôốồổộỗơớờởợỡúùủũụưứừửữựíìỉĩịýỳỷỹỵ"),
            new Vocabulary("ÁÀẢẠÃĂẮẰẲẴẶÂẤẦẨẪẬĐÉÈẺẼẸÊẾỀỂỄỆÓÒỎÕỌÔỐỒỔỘỖƠỚỜỞỢỠÚÙỦŨỤƯỨỪỬỮỰÍÌỈĨỊÝỲỶỸỴ"),
            new Vocabulary("₫")
    );

    public static final Vocabulary ZULU = ENGLISH;

    public static final Vocabulary AZERBAIJANI = concat(removeChars(ENGLISH, "Ww"), new Vocabulary("çəğöşüÇƏĞÖŞÜ"),
            new Vocabulary("₼"));

    public static final Vocabulary BOSNIAN = concat(removeChars(ENGLISH, "QqWwXxYy"), new Vocabulary("čćđšžČĆĐŠŽ"));

    public static final Vocabulary ESPERANTO = concat(removeChars(ENGLISH, "QqWwXxYy"), new Vocabulary("ĉĝĥĵŝŭĈĜĤĴŜŬ"),
            new Vocabulary("₷"));

    public static final Vocabulary FRISIAN = concat(removeChars(ENGLISH, "QqXx"), new Vocabulary("âêôûúÂÊÔÛÚ"),
            new Vocabulary("ƒƑ"));

    public static final Vocabulary GALICIAN = concat(removeChars(ENGLISH, "JjKkWw"), new Vocabulary("ñÑçÇ"));

    public static final Vocabulary HAUSA = concat(removeChars(ENGLISH, "JjKkWw"), new Vocabulary("ɓɗƙƴƁƊƘƳ"),
            new Vocabulary("₦"));

    public static final Vocabulary ICELANDIC = concat(removeChars(ENGLISH, "CcQqWw"),
            new Vocabulary("ðáéíóúýþæöÐÁÉÍÓÚÝÞÆÖ"));

    public static final Vocabulary LATVIAN = concat(removeChars(ENGLISH, "QqWwXx"),
            new Vocabulary("āčēģīķļņšūžĀČĒĢĪĶĻŅŠŪŽ"));

    public static final Vocabulary LITHUANIAN = concat(removeChars(ENGLISH, "QqWwXx"),
            new Vocabulary("ąčęėįšųūžĄČĘĖĮŠŲŪŽ"));

    public static final Vocabulary MALAGASY = concat(removeChars(ENGLISH, "CcQqUuWwXx"), new Vocabulary("ôñÔÑ"));

    public static final Vocabulary MALTESE = concat(removeChars(ENGLISH, "CcYy"), new Vocabulary("ċġħżĊĠĦŻ"));

    public static final Vocabulary MAORI = concat(removeChars(ENGLISH, "BbCcDdFfJjLlOoQqSsVvXxYyZz"),
            new Vocabulary("āēīōūĀĒĪŌŪ"));

    public static final Vocabulary MONTENEGRIN = concat(removeChars(ENGLISH, "QqWwXxYy"), new Vocabulary("čćšžźČĆŠŚŽŹ"));

    public static final Vocabulary QUECHUA = concat(removeChars(ENGLISH, "BbDdFfGgJjVvXxZz"), new Vocabulary("ñÑĉĈçÇ"));

    public static final Vocabulary SCOTTISH_GAELIC = concat(removeChars(ENGLISH, "JjKkQqVvWwXxYyZz"),
            new Vocabulary("àèìòùÀÈÌÒÙ"));

    public static final Vocabulary SLOVENE = concat(removeChars(ENGLISH, "QqWwXxYy"), new Vocabulary("čćđšžČĆĐŠŽ"));

    public static final Vocabulary SOMALI = concat(removeChars(ENGLISH, "PpVvZz"));

    public static final Vocabulary SWAHILI = concat(removeChars(ENGLISH, "QqXx"));

    public static final Vocabulary TAGALOG = concat(removeChars(ENGLISH, "CcQqWwXx"), new Vocabulary("ñÑ"),
            new Vocabulary("₱"));

    public static final Vocabulary TURKISH = concat(removeChars(ENGLISH, "QqWwXx"), new Vocabulary("çğıöşüâîûÇĞİÖŞÜÂÎÛ"),
            new Vocabulary("₺"));

    public static final Vocabulary UZBEK_LATIN = concat(removeChars(ENGLISH, "Ww"), new Vocabulary("çğɉñöşÇĞɈÑÖŞ"));

    public static final Vocabulary WELSH = concat(removeChars(ENGLISH, "KkQqVvXxZz"), new Vocabulary("âêîôŵŷÂÊÎÔŴŶ"));

    public static final Vocabulary YORUBA = concat(removeChars(ENGLISH, "KkQqVvXxZz"), new Vocabulary("ẹọṣẸỌṢ"),
            new Vocabulary("₦"));

    public static final Vocabulary RUSSIAN = concat(
    ...
    public static final Vocabulary BELARUSIAN = concat(
            GENERIC_CYRILLIC_LETTERS,
            RUSSIAN_CYRILLIC_LETTERS,
            DIGITS,
            PUNCTUATION,
    ...
    public static final Vocabulary UKRAINIAN = concat(
            GENERIC_CYRILLIC_LETTERS,
            DIGITS,
            PUNCTUATION,
            CURRENCY,
            new Vocabulary("ґіїєҐІЇЄ₴")
    );

    public static final Vocabulary TATAR = concat(
            RUSSIAN,
            new Vocabulary("ӘәҖҗҢңӨөҮү")
    );

    public static final Vocabulary TAJIK = concat(
            removeChars(RUSSIAN, "₽"),
            new Vocabulary("ҒғҚқҲҳҶҷӢӣӮӯ")
    );

    public static final Vocabulary KAZAKH = concat(
            removeChars(RUSSIAN, "₽"),
            new Vocabulary("ӘәҒғҚқҢңӨөҰұҮүҺһІі"),
            new Vocabulary("₸")
    );

    public static final Vocabulary KYRGYZ = concat(
            removeChars(RUSSIAN, "₽"),
            new Vocabulary("ҢңӨөҮү")
    );

    public static final Vocabulary BULGARIAN = concat(
            GENERIC_CYRILLIC_LETTERS,
            RUSSIAN_SIGNS,
            DIGITS,
            PUNCTUATION,
    ...
    public static final Vocabulary MACEDONIAN = concat(
            GENERIC_CYRILLIC_LETTERS,
            DIGITS,
            PUNCTUATION,
            CURRENCY,
            new Vocabulary("ЃѓЅѕЈјЉљЊњЌќЏџ")
    );

    public static final Vocabulary MONGOLIAN = concat(
            GENERIC_CYRILLIC_LETTERS,
            RUSSIAN_CYRILLIC_LETTERS,
            RUSSIAN_SIGNS,
            DIGITS,
            PUNCTUATION,
            CURRENCY,
            new Vocabulary("ӨөҮү᠐᠑᠒᠓᠔᠕᠖᠗᠘᠙₮")  // Mongolian digits and currency
    );

    public static final Vocabulary YAKUT = concat(
            GENERIC_CYRILLIC_LETTERS,
            RUSSIAN_CYRILLIC_LETTERS,
            RUSSIAN_SIGNS,
            DIGITS,
            PUNCTUATION,
            CURRENCY,
            new Vocabulary("ҔҕҤҥӨөҺһҮү₽")
    );

    public static final Vocabulary SERBIAN_CYRILLIC = concat(
            new Vocabulary("абвгдежзиклмнопрстуфхцчшАБВГДЕЖЗИКЛМНОПРСТУФХЦЧШ"),
            new Vocabulary("JjЂђЉљЊњЋћЏџ"),
            DIGITS,
            PUNCTUATION,
            CURRENCY
    );

    public static final Vocabulary UZBEK_CYRILLIC = concat(
            GENERIC_CYRILLIC_LETTERS,
            RUSSIAN_CYRILLIC_LETTERS,
            RUSSIAN_SIGNS,
            DIGITS,
            PUNCTUATION,
            CURRENCY,
            new Vocabulary("ЎўҚқҒғҲҳ")
    );

    // Greek
    public static final Vocabulary GREEK = concat(
            PUNCTUATION,
            ANCIENT_GREEK,
            CURRENCY,
            new Vocabulary("άέήίϊΐόύϋΰώΆΈΉΊΪΌΎΫΏ")
    );

    public static final Vocabulary GREEK_EXTENDED = concat(
            GREEK,
            new Vocabulary(
                    "ͶͷϜϝἀἁἂἃἄἅἆἇἈἉἊἋἌἍἎἏἐἑἒἓἔἕἘἙἚἛἜἝ" +
                            "ἠἡἢἣἤἥἦἧἨἩἪἫἬἭἮἯἰἱἲἳἴἵἶἷἸἹἺἻἼἽἾἿ" +
                            "ὀὁὂὃὄὅὈὉὊὋὌὍὐὑὒὓὔὕὖὗὙὛὝὟὠὡὢὣὤὥὦὧὨὩὪὫὬὭὮὯ" +
                            "ὰὲὴὶὸὺὼᾀᾁᾂᾃᾄᾅᾆᾇᾈᾉᾊᾋᾌᾍᾎᾏᾐᾑᾒᾓᾔᾕᾖᾗᾘᾙᾚᾛᾜᾝᾞᾟᾠᾡᾢᾣᾤᾥᾦᾧᾨᾩᾪᾫᾬᾭᾮᾯᾲᾳᾴᾶᾷᾺᾼῂῃῄῆῇῈῊῌῒΐῖῗῚῢΰῤῥῦῧῪῬῲῳῴῶῷῸῺῼ"
            )
    );

    // Hebrew
    public static final Vocabulary HEBREW = concat(
            DIGITS,
            PUNCTUATION,
            HEBREW_CONSONANTS,
            HEBREW_VOWELS,
    ...
    // Arabic
    public static final Vocabulary ARABIC = concat(
            DIGITS,
            ARABIC_DIGITS,
            ARABIC_LETTERS,
            PERSIAN_LETTERS,
    ...
    public static final Vocabulary PERSIAN = ARABIC;

    public static final Vocabulary URDU = concat(
            PERSIAN,
            new Vocabulary("ٹڈڑںھےہۃ")
    );

    public static final Vocabulary PASHTO = concat(
            PERSIAN,
            new Vocabulary("ټډړږښځڅڼېۍ")
    );

    public static final Vocabulary KURDISH = concat(
            PERSIAN,
            new Vocabulary("ڵڕۆێە")
    );

    public static final Vocabulary UYGHUR = concat(
            PERSIAN,
            new Vocabulary("ەېۆۇۈڭھ")
    );

    public static final Vocabulary SINDHI = concat(
            PERSIAN,
            new Vocabulary("ڀٿٺٽڦڄڃڇڏڌڊڍڙڳڱڻھ")
    );

    public static final Vocabulary DEVANAGARI = concat(
            ...
            DEVANAGARI_SIGNS,
            PUNCTUATION,  // western punctuation used in Devanagari
            new Vocabulary("₹")  // currency
    );

    public static final Vocabulary HINDI = DEVANAGARI;

    public static final Vocabulary SANSKRIT = DEVANAGARI;

    public static final Vocabulary MARATHI = DEVANAGARI;

    public static final Vocabulary NEPALI = DEVANAGARI;

    // Gujarati
    public static final Vocabulary GUJARATI = concat(
            GUJARATI_CONSONANTS,
            GUJARATI_VOWELS,
            GUJARATI_DIGITS,
            GUJARATI_MATRAS,
            ...
            PUNCTUATION,  // western punctuation used in Gujarati
            GUJARATI_SIGNS,
            new Vocabulary("૱")  // currency
    );

    // Bengali
    public static final Vocabulary BENGALI = concat(
            BENGALI_CONSONANTS,
            BENGALI_VOWELS,
            BENGALI_DIGITS,
            BENGALI_MATRAS,
            BENGALI_VIRAMA,
            BENGALI_PUNCTUATION,
            PUNCTUATION,  // western punctuation used in Bengali
            BENGALI_SIGNS,
            new Vocabulary("৳")  // currency
    );

    // Tamil
    public static final Vocabulary TAMIL = concat(
            TAMIL_CONSONANTS,
            TAMIL_VOWELS,
            TAMIL_DIGITS,
            TAMIL_MATRAS,
            TAMIL_VIRAMA,
            TAMIL_PUNCTUATION,
            PUNCTUATION,  // western punctuation used in Tamil
            TAMIL_FRACTIONS,  // Tamil-specific addition
            TAMIL_SIGNS,
            new Vocabulary("₹")  // currency
    );

    public static final Vocabulary TELUGU = concat(
            TELUGU_CONSONANTS,
            TELUGU_VOWELS,
            TELUGU_DIGITS,
            TELUGU_MATRAS,
            TELUGU_VIRAMA,
            TELUGU_PUNCTUATION,
            PUNCTUATION,  // western punctuation used in Telugu
            TELUGU_SIGNS,
            new Vocabulary("₹")  // currency
    );

    public static final Vocabulary KANNADA = concat(
            KANNADA_CONSONANTS,
            KANNADA_VOWELS,
            KANNADA_DIGITS,
            KANNADA_MATRAS,
            KANNADA_VIRAMA,
            KANNADA_PUNCTUATION,
            PUNCTUATION,  // western punctuation used in Kannada
            KANNADA_SIGNS,
            new Vocabulary("₹")  // currency
    );

    public static final Vocabulary SINHALA = concat(
            SINHALA_CONSONANTS,
            SINHALA_VOWELS,
            SINHALA_DIGITS,
            SINHALA_MATRAS,
            SINHALA_VIRAMA,
            SINHALA_PUNCTUATION,
            PUNCTUATION,  // western punctuation used in Sinhala
            SINHALA_SIGNS,
            new Vocabulary("₹")  // currency
    );

    public static final Vocabulary MALAYALAM = concat(
            MALAYALAM_CONSONANTS,
            MALAYALAM_VOWELS,
            MALAYALAM_DIGITS,
            MALAYALAM_MATRAS,
            MALAYALAM_VIRAMA,
            PUNCTUATION,  // western punctuation used in Malayalam
            MALAYALAM_SIGNS,
            new Vocabulary("₹")  // currency
    );

    public static final Vocabulary PUNJABI = concat(
            PUNJABI_CONSONANTS,
            PUNJABI_VOWELS,
            PUNJABI_DIGITS,
            PUNJABI_MATRAS,
            PUNJABI_VIRAMA,
            PUNJABI_PUNCTUATION,
            PUNCTUATION,  // western punctuation used in Punjabi
            PUNJABI_SIGNS,
            new Vocabulary("₹")  // currency
    );

    public static final Vocabulary ODIA = concat(
            ODIA_CONSONANTS,
            ODIA_VOWELS,
            ODIA_DIGITS,
            ODIA_MATRAS,
            ODIA_VIRAMA,
            ODIA_PUNCTUATION,
            PUNCTUATION,  // western punctuation used in Odia
            ODIA_SIGNS,
            new Vocabulary("₹")  // currency
    );

    public static final Vocabulary KHMER = concat(
            KHMER_CONSONANTS,
            KHMER_VOWELS,
            KHMER_DIGITS,
            KHMER_MATRAS,
            KHMER_VIRAMA,
            KHMER_DIACRITICS,  // Khmer-specific addition
            KHMER_PUNCTUATION,
            PUNCTUATION,  // western punctuation used in Khmer
            new Vocabulary("៛")  // Cambodian currency
    );

    // Armenian
    public static final Vocabulary ARMENIAN = concat(
            new Vocabulary("ԱԲԳԴԵԶԷԸԹԺԻԼԽԾԿՀՁՂՃՄՅՆՇՈՉՊՋՌՍՎՏՐՑՒՓՔՕՖՙՠաբգդեզէըթժիլխծկհձղճմյնշոչպջռսվտրցւփքօֆևֈ"),
            DIGITS,
            PUNCTUATION,
            new Vocabulary("՚՛՜՝՞՟։֊"),
            new Vocabulary("֏")
    ...
    // Sudanese
    public static final Vocabulary SUDANESE = concat(
            DIGITS,
            SUDANESE_DIGITS,
            SUDANESE_CONSONANTS,
            SUDANESE_VOWELS,
    ...
    // Thai
    public static final Vocabulary THAI = concat(
            DIGITS,
            new Vocabulary("๐๑๒๓๔๕๖๗๘๙"),
            PUNCTUATION,
            new Vocabulary("๏๚๛ๆฯ"),
            new Vocabulary("กขฃคฅฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรฤลฦวศษสหฬอฮ"),  // Thai consonants
            new Vocabulary("ะาำเแโใไๅ"),  // Thai vowels
            new Vocabulary("ัิีึืฺุู็่้๊๋์ํ๎"),  // Thai diacritics (spaces removed)
            new Vocabulary("฿")
    );

    public static final Vocabulary LAO = concat(
            DIGITS,
            new Vocabulary("໐໑໒໓໔໕໖໗໘໙"),
            PUNCTUATION,
            new Vocabulary("ໆໞໟຯ"),
            new Vocabulary("ກຂຄຆງຈຉຊຌຍຎຏຐຑຒຓດຕຖທຘນບປຜຝພຟຠມຢຣລວຨຩສຫຬອຮ"),  // Lao consonants
            new Vocabulary("ະາຳຽເແໂໃໄ"),  // Lao vowels
            new Vocabulary("ໜໝ"),  // Lao ligature
            new Vocabulary("ັິີຶື຺ຸູົຼ່້໊໋໌ໍ")
    );

    public static final Vocabulary BURMESE = concat(
            DIGITS,
            BURMESE_DIGITS,
            BURMESE_CONSONANTS,
            BURMESE_VOWELS,
    ...
    public static final Vocabulary JAVANESE = concat(
            DIGITS,
            JAVANESE_DIGITS,
            JAVANESE_CONSONANTS,
            JAVANESE_VOWELS,
            ...
            PUNCTUATION // western punctuation used in Javanese
    );

    // Georgian (Mkhedruli - modern)
    public static final Vocabulary GEORGIAN = concat(
            DIGITS,
            new Vocabulary("ႠႡႢႣႤႥႦႧႨႩႪႫႬႭႮႯႰႱႲႳႴႵႶႷႸႹႺႻႼႽႾႿჀჁჂჃჄჅჇჍაბგდევზთიკლმნოპჟრსტუფქღყშჩცძწჭხჯჰჱჲჳჴჵჶჷჸჹჺჼჽჾჿ"),
            PUNCTUATION,
            new Vocabulary("჻"),
            new Vocabulary("₾")  // currency
    );

    public static final Vocabulary ETHIOPIC = concat(
            new Vocabulary(
    ...
    // East Asian
    public static final Vocabulary JAPANESE = concat(
            DIGITS,
            new Vocabulary("ぁあぃいぅうぇえぉおかがきぎくぐけげこごさざしじすずせぜそぞただちぢっつづ"
                    + "てでとどなにぬねのはばぱひびぴふぶぷへべぺほぼぽまみむめ"
                    + "もゃやゅゆょよらりるれろゎわゐゑをんゔゕゖゝゞゟ"),  // Hiragana
            new Vocabulary("ァアィイゥウェエォオカガキギクグケゲコゴサザシジスズセゼソゾタダ"
                    + "チヂッツヅテデトドナニヌネノハバパヒビピフブプヘベペホボポマミムメ"
                    + "モャヤュユョヨラリルレロヮワヰヱヲンヴヵヶヷヸヹヺーヽヾヿ"),  // Katakana
            // Kanji jōyō (incl. numerals)
            new Vocabulary("亜哀挨愛曖悪握圧扱宛嵐安案暗以衣位囲医依委威為畏胃尉異移萎偉椅彙意違維慰遺緯域育一壱逸茨芋引印因咽姻員院淫陰飲隠韻右宇羽雨唄鬱畝浦運雲"  // noqa: E501
    ...
    public static final Vocabulary KOREAN = concat(DIGITS, new Vocabulary(
    ...
    public static final Vocabulary SIMPLIFIED_CHINESE = concat(DIGITS, new Vocabulary(
    ...
    public static final Vocabulary LATIN_EXTENDED = removeDuplicates(concat(
            LATIN,
            ENGLISH,
            FRENCH,
            PORTUGUESE,
    ...
    public static final Vocabulary MULTI_LANG = removeDuplicates(concat(
            ENGLISH,
            ALBANIAN,
            AFRIKAANS,
            AZERBAIJANI,
    ...
    public static final Vocabulary MULTI_LANG_FULL = removeDuplicates(concat(MULTI_LANG,
            ARMENIAN, BENGALI, BURMESE, ETHIOPIC, GEORGIAN, GREEK_EXTENDED, GUJARATI, HINDI, HINDI_DIGITS, JAPANESE,
            JAVANESE, KANNADA, KHMER, KOREAN, KURDISH, LAO, LEGACY_FRENCH, MALAYALAM, MARATHI, NEPALI, ODIA, PASHTO,
            PUNJABI, SANSKRIT, SINDHI, SIMPLIFIED_CHINESE, SINHALA, SUDANESE, TAMIL, TELUGU, THAI, URDU, UYGHUR
    ));
     ...
     *
     * @param vocab vocabularies to remove duplicates
     *
     * @return updated vocabulary
     */
    private static Vocabulary removeDuplicates(Vocabulary vocab) {
        StringBuilder uniqueChars = new StringBuilder();
        HashSet<Character> seen = new HashSet<>();

        for (char c : vocab.toString().toCharArray()) {
            if (seen.add(c)) {
                uniqueChars.append(c);
            }
        }
        return new Vocabulary(uniqueChars.toString());
    }

    /**
     * Removes characters from the vocabulary.
     *
     * @param source vocabularies to remove characters
     * @param charsToRemove characters to remove
     *
     * @return updated vocabulary
     */
    private static Vocabulary removeChars(Vocabulary source, String charsToRemove) {
        ...
        return new Vocabulary(filtered.toString());
    }
}
