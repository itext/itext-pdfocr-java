...
@Tag("IntegrationTest")
public class TextPositioningModeEASYTest extends ExtendedITextTest {
    ...
    private static final String TARGET_DIRECTORY = "./target/test/resources/com/itextpdf/pdfocr/text/TextPositioningModeEASYTest/";
