...
public class OnnxOrientationPredictorTest extends ExtendedITextTest {
    private static final String TEST_DIRECTORY =
            "./src/test/resources/com/itextpdf/pdfocr/onnx/orientation/OnnxOrientationPredictorTest/";
    private static final String TARGET_DIRECTORY =
            "./target/test/resources/com/itextpdf/pdfocr/onnx/orientation/OnnxOrientationPredictorTest/";
