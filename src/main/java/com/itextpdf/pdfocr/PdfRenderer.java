...
import com.itextpdf.pdfocr.tesseract4.ImageUtil;
import com.itextpdf.pdfocr.tesseract4.LogMessageConstant;
...
public class PdfRenderer {
    ...
    public String getDefaultFontName() {
        return GeneralUtil.FONT_RESOURCE_PATH + DEFAULT_FONT_NAME;
    }
    ...
    private void addToCanvas(final PdfDocument pdfDocument, final PdfFont font,
        ...
        float multiplier = imageData == null
                ...
                / PdfUtil.getPoints(imageData.getWidth());
                ...
                try {
                    ...
                    try {
                        ...
                        ImageIO.write(bufferedImage,
                                GeneralUtil.getPngImageFormat(), baos);
                        ImageData imageData = ImageDataFactory
    ...
    private void addTextToCanvas(
        ...
        if (pageText == null || pageText.size() == 0) {
            ...
            for (TextInfo item : pageText) {
                ...
                float bboxWidthPt = PdfUtil.getPoints(right - left);
                float bboxHeightPt = PdfUtil.getPoints(bottom - top);
                if (!line.isEmpty() && bboxHeightPt > 0 && bboxWidthPt > 0) {
                    ...
                    float deltaX = PdfUtil.getPoints(left);
                    float deltaY = imageSize.getHeight()
                            - PdfUtil.getPoints(bottom);
