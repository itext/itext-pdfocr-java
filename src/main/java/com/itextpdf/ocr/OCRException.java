...
public class OCRException extends com.itextpdf.io.IOException {
    ...
    public static final String OUTPUT_INTENT_CANNOT_BE_NULL = "Output intent can not be null for "
            + "PDF/A-3u document";
    ...
    public static final String TESSERACT_FAILED = "Tesseract failed. Please check "
            + "provided parameters";
    public static final String TESSERACT_FAILED_WITH_REASON = "Tesseract failed. {0}";
    public static final String CANNOT_FIND_PATH_TO_TESSERACT_EXECUTABLE = "Cannot find path to "
